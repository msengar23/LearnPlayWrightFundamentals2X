    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <p className="text-sm text-slate-600 dark:text-slate-400 mb-3">
          SnapLocator requests three Chrome permissions. Here's why each is needed:
        </p>
        ...
        <p className="text-sm text-slate-600 dark:text-slate-400">
          snaplocator.com itself uses no analytics, no cookies, and no third-party scripts. The page
