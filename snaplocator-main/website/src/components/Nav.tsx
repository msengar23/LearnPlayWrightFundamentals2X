    ...
    <nav className="sticky top-0 z-40 w-full backdrop-blur bg-white/80 dark:bg-zinc-950/80 border-b border-slate-200 dark:border-zinc-800">
      <div className="max-w-6xl mx-auto px-6 py-3 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2">
          <span className="inline-flex items-center justify-center w-8 h-8 rounded-md bg-emerald-600 text-white font-mono font-bold text-sm">SL</span>
          <span className="font-semibold text-lg">SnapLocator</span>
        </Link>
        <div className="flex items-center gap-2 text-sm">
          ...
          <a
            href="https://github.com/PramodDutta/snaplocator"
            target="_blank"
            rel="noreferrer"
