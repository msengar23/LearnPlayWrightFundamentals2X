const QUESTIONS = [
  {
    q: 'Is SnapLocator really free?',
    a: 'Yes. Free forever. No paid tier, no trial, no signup. Built and maintained by The Testing Academy as a learning tool for the QA community.',
  },
  {
    q: 'Do you collect any data?',
    a: 'No. SnapLocator runs 100% locally in your browser. No telemetry, no analytics, no remote calls. Your settings live in chrome.storage.sync (owned by your Chrome profile).',
  },
  {
  ...
  },
  {
    ...
    a: 'Yes. SnapLocator auto-detects shadow root boundaries and iframe contexts. For Playwright it emits frameLocator() wrappers automatically. For other frameworks it provides matching idiomatic helpers.',
  },
  {
