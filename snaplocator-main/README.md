...
[![Free](https://img.shields.io/badge/Free-Forever-10b981)](https://snaplocator.com)
[![License: MIT](https://img.shields.io/badge/License-MIT-emerald.svg)](./LICENSE)
[![Version](https://img.shields.io/badge/version-0.8.0-emerald)](./extension/package.json)

**Live site:** [snaplocator.com](https://snaplocator.com)

---

## What it does

Open Chrome DevTools, click any element in the DOM tree (or use the pick mode), and SnapLocator produces a ranked list of test locators across 9 frameworks. Live match counts, stability ratings, parameterized smart patterns, self-healing chains, Selenium 4 relative locators, recorder, freeze mode, page-wide export — all in one DevTools tab.
...
flowchart LR
    ...
    subgraph Extension["SnapLocator extension (MV3)"]
    ...
    Website[website/<br/>Vite + React<br/>snaplocator.com] -.->|hosts .zip downloads| User
```
...
npm run package     # zips dist/ → ../website/public/downloads/snaplocator-v{VERSION}.zip
```
...
3. Open any page → F12 → **SnapLocator** tab (or pin the SnapLocator sidebar inside Elements)
...
See [`How_To_Create.md`](./How_To_Create.md) for the actual prompt sequence used to build SnapLocator with Claude Code.

## Contributing

Built by [The Testing Academy](https://thetestingacademy.com). Open to PRs.
