...
export function Toolbar({
  ...
  return (
    <div className="qlc-toolbar">
      <a
        className="qlc-brand"
        href="https://snaplocator.com"
        target="_blank"
        rel="noreferrer"
        title="snaplocator.com · no ads, no tracking, no BS"
      >
        <span className="qlc-brand-mark" aria-hidden>SL</span>
        <div className="qlc-brand-text">
          <span className="qlc-brand-name">Snap<span className="qlc-brand-dot">Locator</span></span>
